...
// Résultats publics — chargés depuis Firebase Firestore + téléchargement via URL Firebase Storage

import { createFileRoute } from '@tanstack/react-router'
import { useState, useEffect } from 'react'
import { getResults, type AcademicResult } from '@/lib/scire-store'
...
function ResultsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      {/* Contenu */}
      {loading ? (
        <div className="text-center py-16 text-gray-400">Chargement des résultats…</div>
      ) : filtered.length === 0 ? (
        <div
